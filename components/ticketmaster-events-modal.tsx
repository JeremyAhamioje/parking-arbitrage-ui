...
import { TicketmasterEventsFeed } from './ticketmaster-events-feed'

interface TicketmasterEventsModalProps {
  isOpen: boolean
  onClose: () => void
}

export function TicketmasterEventsModal({ isOpen, onClose }: TicketmasterEventsModalProps) {
